...
public class NestedIf01 {
     ...
     */
    /*
        bir kelimeyi parantez, cift tirnak, tek tirnak icine almak istersek
        ilgili kelimeyi secip sadece bu tuslara basariz
     */
...
//        double c = Math.abs(input.nextDouble());
        ...
        // if lerin icini cok uzun olmasi istenen bir durum degildir
