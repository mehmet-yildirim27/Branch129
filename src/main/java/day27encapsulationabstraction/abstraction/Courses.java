...
public abstract class Courses {
    ...
    */
    ...
    // abstract method bir kere override edilmek zorunda
    // Mesela A abstract ve icerisinde bir tane abstract method var. B, A'nin childi ve o da abstract. A daki abstract methodu override etmis (zorunlulugu yok ama abstract oldugu icin)
    // C' de B'nin childi ve A'daki abstract methodu override etmemis. Bu örnekte problem yok. Abstract metodun bir kere override edilmesi yeter. Child etmis ise, grandchildin etmesine gerek yok mesela
    // Abstaraction OOP'nin 4 temel yapi tasindan bir tanesidir.
    // Abstraction 2 bölümden olusur . 1) Abstraction   2) Interface
